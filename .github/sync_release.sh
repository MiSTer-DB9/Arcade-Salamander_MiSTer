...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-Salamander_MiSTer.git"
CORE_NAME=(Arcade-Salamander)
...
UPSTREAM_CORE_NAME=(Arcade-Salamander)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(Salamander.qpf)
COMPILATION_OUTPUT=(output_files/Salamander.rbf)
